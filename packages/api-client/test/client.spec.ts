...
import { createG3Client } from '../src/index';

describe('createG3Client', () => {
  it('cria um client com os verbos tipados', () => {
    const client = createG3Client({ baseUrl: 'http://localhost:3333' });
  ...
  it('usa o fetch injetado e envia credenciais', async () => {
    ...
    const client = createG3Client({ baseUrl: 'http://api.test', fetch: fetchMock });
