...
function Card({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-lg border border-border bg-white p-5">
      ...
      <p className="mt-1 font-serif text-2xl font-semibold text-navy-800">{value}</p>
    </div>
  );
}
...
export function DashboardPage() {
  ...
  return (
    <div>
      <h1 className="mb-6 font-serif text-3xl font-semibold text-navy-800">Painel</h1>
      ...
      <h2 className="mb-3 mt-10 font-serif text-xl font-semibold text-navy-800">Funil de leads</h2>
