  ...
  return (
    <button
      ...
      className={`-mb-px border-b-2 px-4 py-2 text-sm font-semibold transition-colors ${
        active ? 'border-navy-700 text-navy-800' : 'border-transparent text-muted hover:text-ink'
      }`}
    >
      {children}
    </button>
...
const LEAD_STAGES: Array<{ value: LeadStage; label: string; color: string }> = [
  ...
  { value: 'qualified', label: 'Qualificado', color: '#c9a14b' },
  ...
  return (
    <div>
      <div className="mb-4 flex items-baseline justify-between">
        <h1 className="font-serif text-2xl font-semibold text-navy-800">Funil de leads</h1>
          ...
          return (
            <div
              ...
              className={`flex w-72 shrink-0 flex-col rounded-xl border p-3 transition-colors ${
                isOver ? 'border-navy-700 bg-navy-50' : 'border-border bg-paper/60'
              }`}
            >
...
const OPP_STAGES: Array<{ value: OppStage; label: string; color: string }> = [
  ...
  { value: 'proposta', label: 'Proposta', color: '#c9a14b' },
  ...
  return (
    <div>
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <h1 className="font-serif text-2xl font-semibold text-navy-800">Funil de vendas</h1>
  ...
  return (
    ...
    >
      ...
      <div className="mt-1 flex items-center justify-between text-xs">
        <span className="font-semibold text-navy-800">{formatBRL(opp.valueCents)}</span>
  ...
  return (
    <div className="flex gap-1">
      <button
        ...
        disabled={!onPrev}
        onClick={onPrev}
        className="grid h-6 w-6 place-items-center rounded border border-border text-muted hover:enabled:border-navy-700 hover:enabled:text-navy-700 disabled:opacity-30"
