...
import { Badge, Button, buttonClasses } from '@g3/ui';
  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        <h1 className="font-serif text-3xl font-semibold text-navy-800">Cursos</h1>
              ...
              {courses.map((c) => (
                <tr key={c.id}>
                  <td className="px-4 py-3 font-medium text-ink">
                    <Link to={`/cursos/${c.id}`} className="hover:text-navy-700 hover:underline">
                      {c.title}
                    </Link>
                  </td>
