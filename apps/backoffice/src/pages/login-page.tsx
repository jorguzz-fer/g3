...
export function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col justify-center overflow-hidden bg-navy-900 px-6 py-12 text-white">
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -right-24 -top-24 h-96 w-96 rounded-full bg-navy-700/25 blur-3xl"
      />
      <div
        aria-hidden="true"
      ...
      <div className="relative mx-auto w-full max-w-sm">
        ...
        <p className="mt-2 text-white/60">Acesse o painel administrativo da G3.</p>
