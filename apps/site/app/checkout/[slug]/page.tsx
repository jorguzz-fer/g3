    ...
    <div className="bg-paper">
      ...
      {course.comingSoon ? (
        <div className="mx-auto max-w-[720px] px-6 py-16 text-center">
          ...
          <h1 className="mt-2 font-serif text-3xl font-semibold text-navy-800">
          ...
          <Link
            href={`/cursos/${course.slug}`}
            className="mt-6 inline-flex items-center gap-1 text-sm font-semibold text-navy-700 hover:underline"
          >
            Ver o curso
          </Link>
        </div>
