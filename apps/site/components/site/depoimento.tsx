    ...
    >
      <div className="wrap">
        <div className="quote">
          ...
          <p className="qm">
            “A G3 mudou a rotina de estudo da minha equipe. Consigo <b>matricular todo mundo</b>,
            acompanhar as horas e ainda revisar os casos entre um plantão e outro.”
          </p>
          <div className="qa">
            <div className="av">J</div>
            <div className="nm">
              <b>Juliana Rocha</b>
              <span>Gerente de enfermagem · Hospital Santa Clara</span>
            </div>
          </div>
        </div>
      </div>
