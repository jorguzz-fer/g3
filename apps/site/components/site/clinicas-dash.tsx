  ...
  return (
    <section className="dash" id="clinicas">
      <div className="wrap dash-in">
        <span className="eyebrow">Para instituições e serviços de saúde</span>
        <h2>Gestão de aprendizagem para a sua equipe</h2>
        <p className="lead-p">
          Matricule sua equipe, acompanhe conclusões e horas de formação e comprove a educação
          permanente do serviço, tudo em um painel.
        </p>
          ...
          <div className="b-body">
            ...
            <div className="panel">
              <div className="panel-h">
                <h3>Visão geral · Hospital Santa Clara</h3>
                <div className="who">
              ...
              <div className="grid2">
                <div className="card-d">
                  <div className="cdh">
                    ...
                    <div className="lg">
                      <span>
                        <i style={{ background: '#DCB35F' }} />
                        Concluídos
                      </span>
                      <span>
                        <i style={{ background: 'rgba(184,154,90,.3)' }} />
                        Matrículas
                      </span>
                    </div>
                  </div>
                  ...
                  >
                    <defs>
                      <linearGradient id="ga" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="0" stopColor="#DCB35F" stopOpacity=".38" />
                        <stop offset="1" stopColor="#DCB35F" stopOpacity="0" />
                      </linearGradient>
                    </defs>
                ...
                <div className="card-d">
                  <div className="cdh">
                    <b>Turmas ativas</b>
                    <span style={{ fontSize: '10.5px', color: '#939aa9' }}>4 turmas</span>
                  </div>
                  <div className="tbl">
                    <div className="tr">
                      <div className="nmw">
                        <span
                          className="ci"
                          style={{ background: 'linear-gradient(135deg,#122c60,#0a162e)' }}
                        >
                          <svg
                            viewBox="0 0 24 24"
                            fill="none"
                        ...
                        <div style={{ minWidth: 0 }}>
                          <div className="t1">Urgência e Emergência</div>
                    ...
                    <div className="tr">
                      <div className="nmw">
                        <span
                          className="ci"
                          style={{ background: 'linear-gradient(135deg,#3a455a,#0f1a2f)' }}
                        >
                          <svg
                            viewBox="0 0 24 24"
                            fill="none"
                        ...
                        <div style={{ minWidth: 0 }}>
                          <div className="t1">Terapia Intensiva</div>
                    ...
                    <div className="tr">
                      <div className="nmw">
                        <span
                          className="ci"
                          style={{ background: 'linear-gradient(135deg,#8a6d2e,#4a3a18)' }}
                        >
                          <svg
                            viewBox="0 0 24 24"
                            fill="none"
                        ...
                        <div style={{ minWidth: 0 }}>
                          <div className="t1">Nutrição Clínica</div>
                    ...
                    <div className="tr">
                      <div className="nmw">
                        <span
                          className="ci"
                          style={{ background: 'linear-gradient(135deg,#2f3e5b,#101b30)' }}
                        >
                          <svg
                            viewBox="0 0 24 24"
                            fill="none"
                        ...
                        <div style={{ minWidth: 0 }}>
                          <div className="t1">Saúde Mental</div>
                          <div className="t2">9 alunos</div>
                        </div>
                      </div>
                      <div className="prg">
