    ...
    >
      <div
        ...
        style={{
          ...
          borderRadius: 16,
          padding: 24,
          boxShadow: '0 20px 60px rgba(2,8,20,.35)',
          color: '#141A26',
        }}
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <strong style={{ fontSize: 18 }}>Fale com a equipe G3</strong>
          <button
            type="button"
            onClick={onClose}
            aria-label="Fechar"
        ...
        {done ? (
          <div style={{ marginTop: 16 }}>
            ...
            <p style={{ margin: '6px 0 0', color: '#4A5570', fontSize: 14 }}>
          ...
          >
            ...
            <p style={{ margin: 0, color: '#4A5570', fontSize: 12 }}>
