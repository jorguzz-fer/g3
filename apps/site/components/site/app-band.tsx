    ...
    <section className="app-band" id="app">
      <div className="wrap app-band-in">
        <div className="app-copy">
          ...
          <h2>O plantão inteiro cabe no seu celular</h2>
          <p className="desc">
            ...
            <div className="screen">
              ...
              <div className="app">
                <div className="player-top">
                  <span className="tt">Urgência · Aula 12</span>
                  <div className="pl">
                ...
                <div className="p2">
                  <h4>Classificação de risco na porta</h4>
                  <div className="by">Dra. Mariana Costa</div>
                  <div className="prog">
                  ...
                  <div className="les done">
                    ...
                    <div>
                      <div className="lt">A rede de urgência</div>
                  ...
                  <div className="les done">
                    <div className="ix">✓</div>
                    <div>
                      <div className="lt">Avaliação primária</div>
                      <div className="lm">Concluída</div>
                    </div>
                  ...
                  <div className="les now">
                    <div className="ix">▶</div>
                    <div>
                      <div className="lt">Protocolos de triagem</div>
              ...
              <div className="app">
                <div className="app-head" style={{ paddingTop: 12 }}>
                  <div>
                    ...
                    <div className="nm">Urgência e Emergência</div>
                  </div>
                </div>
                <div className="app-scroll">
                  <div
                    className="continue"
                    style={{ background: 'linear-gradient(120deg,#8a6d2e,#4a3a18)' }}
                  >
                    <div className="k" style={{ color: '#f2e5c9' }}>
                      Sequência de estudos
                    </div>
                    <div className="t">12 dias seguidos 🔥</div>
                    <div className="meta" style={{ color: '#efe1c4' }}>
                  ...
                  <div className="les done" style={{ borderTop: 0 }}>
                    <div className="ix">✓</div>
                    <div>
                      <div className="lt">Suporte Avançado de Vida</div>
                  ...
                  <div className="les done">
                    <div className="ix">✓</div>
                    <div>
                      <div className="lt">Segurança do Paciente</div>
                  ...
                  <div className="les now" style={{ borderTop: 0 }}>
                    <div className="ix">▶</div>
                    <div>
                      <div className="lt">Urgência e Emergência</div>
                  ...
                  <div className="les now">
                    <div
                      className="ix"
                      style={{ background: 'rgba(184,154,90,.25)', color: '#e2c37f' }}
                    >
                      ▶
                    </div>
                    <div>
                      <div className="lt">Terapia Intensiva</div>
