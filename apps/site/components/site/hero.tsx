    ...
    <section className="hero">
      <div className="wrap hero-in">
        <div className="hero-copy">
          <span className="eyebrow">Pós-graduação na área da saúde</span>
          <h1>
            A casa inteira construída
            <br />
          ...
          <div className="hero-cta">
            ...
            <Link
              ...
              style={{ color: '#EAECF1', borderColor: 'rgba(255,255,255,.25)' }}
            >
              Ver cursos
              <svg
                viewBox="0 0 24 24"
              ...
              <div className="app">
                <div className="app-head">
                  ...
                  <div>
                    ...
                    <div className="nm">Enf. Marina</div>
                  </div>
                  <div className="bell">
                ...
                <div className="app-scroll">
                  ...
                  <div className="chips">
                    ...
                    <span className="chip">Urgência</span>
                    <span className="chip">UTI</span>
                    <span className="chip">Nutrição</span>
                  </div>
                  <div className="continue">
                    <div className="k">Continue de onde parou</div>
                    <div className="t">Urgência e Emergência · Classificação de risco</div>
                    <div className="pbar">
                      <i />
                    </div>
                    <div className="meta">
                  ...
                  <div className="cards2">
                    <div className="mc">
                      <div
                        className="thumb"
                        style={{ background: 'linear-gradient(140deg,#122c60,#0a162e)' }}
                      >
                        <svg
                          viewBox="0 0 24 24"
                          fill="none"
                        ...
                        >
                          ...
                          <path d="M2 12.5h4l1.5-3 2.5 6 2-4 1.5 1h6.5" stroke="#DCB35F" />
                        </svg>
                      </div>
                      <div className="body">
                        <div className="tag">Urgência</div>
                        <div className="ti">Suporte avançado de vida</div>
                        <div className="row">
                          <span>⭐ 4.9</span>
                    ...
                    <div className="mc">
                      <div
                        className="thumb"
                        style={{ background: 'linear-gradient(140deg,#8a6d2e,#5a4820)' }}
                      >
                        <svg
                          viewBox="0 0 24 24"
                          fill="none"
                      ...
                      <div className="body">
                        <div className="tag">Fisioterapia</div>
                        <div className="ti">Reabilitação do joelho</div>
                        <div className="row">
                          <span>⭐ 4.8</span>
