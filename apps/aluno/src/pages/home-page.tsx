...
function StatTile({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-xl border border-border bg-white p-4">
      <p className="font-serif text-2xl font-semibold text-navy-800">{value}</p>
...
export function HomePage() {
  ...
  return (
    <div>
      ...
      <h1 className="font-serif text-2xl font-semibold text-navy-800">Olá! 👋</h1>
      ...
      {courses.length === 0 ? (
        ...
        <>
          {continueCourse ? (
            <section className="mt-6 overflow-hidden rounded-2xl border border-border bg-navy-900 text-[#EAECF0] shadow-[0_18px_40px_-24px_rgba(10,31,25,.6)]">
              <div className="flex flex-col gap-5 p-6 sm:flex-row sm:items-center sm:justify-between sm:p-7">
                <div className="min-w-0">
                  ...
                  <div className="mt-3 max-w-sm">
                    ...
                    />
                    <p className="mt-1.5 text-sm text-[#C6CAD3]">
          ...
          <div className="mt-8 flex items-center justify-between">
            ...
            <Link to="/meus-cursos" className="text-sm font-semibold text-navy-700 hover:underline">
              Ver todos →
            </Link>
          </div>
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage: c.coverUrl
                        ? `url(${c.coverUrl})`
                        : 'linear-gradient(135deg,#06173F,#1C3466 60%,#345089)',
                    }}
                  />
