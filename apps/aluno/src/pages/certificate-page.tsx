  ...
  if (cert === 'error') {
    return (
      <div className="max-w-lg">
        <h1 className="mb-2 font-serif text-2xl font-semibold text-navy-800">
        ...
        <Link
          to={`/curso/${slug}`}
          className="mt-4 inline-block text-sm font-semibold text-navy-700 hover:underline"
        >
          ← Voltar ao curso
        </Link>
      </div>
  ...
  return (
    <div>
      <div className="mb-4 flex items-center justify-between gap-3 print:hidden">
        <Link to={`/curso/${slug}`} className="text-sm font-semibold text-navy-700 hover:underline">
          ← Voltar ao curso
        </Link>
      ...
      <div className="print-area">
        <div className="mx-auto max-w-3xl rounded-2xl border-[6px] border-navy-800 bg-white p-8 text-center shadow-[0_20px_60px_-30px_rgba(10,31,25,.5)] sm:p-12">
          <img src="/g3-logo.png" alt="G3 Educação | Saúde" className="mx-auto h-auto w-[150px]" />
          ...
          <h1 className="mt-1 font-serif text-3xl font-semibold text-navy-800 sm:text-4xl">
            {cert.studentName}
          </h1>
          <p className="mx-auto mt-4 max-w-xl text-ink">
            concluiu com êxito o curso <strong className="text-navy-800">{cert.courseTitle}</strong>
            , composto por {cert.lessonsTotal} aula(s) de pós-graduação e educação continuada na
            área da saúde.
          </p>
          ...
          <div className="mt-10 flex items-end justify-center gap-16">
            ...
            <div className="text-center">
              <div className="mx-auto w-48 border-t border-ink/40" />
              <p className="mt-1 text-sm font-semibold text-ink">G3</p>
              <p className="text-xs text-muted">Educação | Saúde</p>
            </div>
          </div>
        </div>
      </div>
