...
export function ProfilePage() {
  ...
  return (
    <div className="max-w-2xl">
      <h1 className="mb-6 font-serif text-2xl font-semibold text-navy-800">Meu perfil</h1>

      <div className="mb-6 flex items-center gap-4 rounded-2xl border border-border bg-white p-5">
        <span className="grid h-14 w-14 place-items-center rounded-full bg-navy-700 font-serif text-xl font-semibold text-gold-400">
        ...
        <span className="ml-auto rounded-full bg-navy-50 px-3 py-1 text-xs font-semibold text-navy-700">
      ...
      >
        <h2 className="font-serif text-base font-semibold text-navy-800">Dados</h2>
        <Field
          label="Nome completo"
          value={name}
      ...
      >
        <h2 className="font-serif text-base font-semibold text-navy-800">Trocar senha</h2>
        <Field
          label="Senha atual"
          type="password"
        ...
        />
        {pwdMsg ? (
          <p className={`text-sm ${pwdMsg.ok ? 'text-navy-700' : 'text-error'}`}>{pwdMsg.text}</p>
        ) : null}
