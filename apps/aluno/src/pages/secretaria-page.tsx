...
export function SecretariaPage() {
  ...
  return (
    <div>
      <h1 className="mb-6 font-serif text-2xl font-semibold text-navy-800">Secretaria online</h1>
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-[minmax(0,380px)_minmax(0,1fr)]">
        ...
        >
          <h2 className="font-serif text-base font-semibold text-navy-800">Nova solicitação</h2>
          <Field
            label="Assunto"
            value={subject}
