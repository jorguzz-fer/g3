...
import { Button, Field, PasswordField } from '@g3/ui';
import { useAuth } from '../auth';

/** Frases que se alternam no painel de marca (efeito máquina de escrever). */
const HEADLINES = [
  'Toda a sua pós-graduação em uma tela só.',
  'Formar quem cuida. Cuidar de quem forma.',
  'Do estudo ao certificado, num só app.',
  'No ritmo dos seus plantões.',
];
    ...
    <div className="grid min-h-screen lg:grid-cols-2">
      ...
      <main className="flex flex-col justify-center bg-paper px-6 py-12 sm:px-12">
        <div className="mx-auto w-full max-w-sm">
          <img src="/g3-logo.png" alt="G3 Educação | Saúde" className="mb-8 h-auto w-[128px]" />
...
function BrandPanel() {
  return (
    <aside className="relative hidden flex-col justify-between overflow-hidden bg-navy-900 p-12 text-white lg:flex">
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -right-24 -top-24 h-96 w-96 rounded-full bg-navy-700/30 blur-3xl"
      />
      <div
        aria-hidden="true"
