  ...
  return (
    <div>
      <div className="rounded-2xl border border-dashed border-border bg-white p-8 text-center">
        <div className="mx-auto mb-4 grid h-14 w-14 place-items-center rounded-full bg-navy-50 text-navy-700">
          <svg
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
        ...
        <p className="mx-auto mt-1 max-w-md text-muted">
          Explore o catálogo G3 e comece sua próxima formação clínica. Assim que você se matricular,
          o curso aparece aqui.
        </p>
              ...
              <li key={c.id}>
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-4">
                    ...
                    <p className="mt-auto font-serif text-lg font-semibold text-navy-800">
