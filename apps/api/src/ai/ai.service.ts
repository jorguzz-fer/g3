...
const SYSTEM_PROMPT = `Você é um(a) assistente de conteúdo da G3 Educação | Saúde, uma
instituição de ensino superior dedicada à formação de profissionais da saúde no
Brasil. A partir do material bruto de um curso
