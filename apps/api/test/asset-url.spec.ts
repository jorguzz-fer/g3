...
const APP = 'https://g3educacaosaude.com.br';
...
describe('resolveAssetUrl', () => {
  ...
  it('prefixa caminho relativo', () => {
    expect(resolveAssetUrl(APP, '/cursos/x.png')).toBe(
      'https://g3educacaosaude.com.br/cursos/x.png',
    );
  });
  ...
  it('troca host local por APP_URL (corrige dados semeados antes do APP_URL)', () => {
    ...
    expect(resolveAssetUrl(APP, 'http://127.0.0.1:3333/instrutores/y.png')).toBe(
      'https://g3educacaosaude.com.br/instrutores/y.png',
    );
  });
  ...
  it('não duplica barra quando APP_URL termina em /', () => {
    expect(resolveAssetUrl('https://g3educacaosaude.com.br/', '/cursos/x.png')).toBe(
      'https://g3educacaosaude.com.br/cursos/x.png',
    );
  });
